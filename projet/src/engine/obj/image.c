...
/**
 * @brief Définition de la structure Image et ses primitives
 * 
*/
...
Image loadImage(char* path){
    /** 
     * @brief Retourne une image à partir d'un fichier
     * Cette fonction permet la convertion de l'image en matrice de pixels
     * @param path le chemin vers le fichier
     * @return une Image correspondant au path
     * 
    */
